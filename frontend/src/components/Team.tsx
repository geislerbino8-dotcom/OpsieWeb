...
const MemberCard = ({ member, isFeatured = false }: { member: TeamMember; isFeatured?: boolean }) => (
  <div className={`group relative bg-white rounded-3xl p-8 transition-all duration-500 hover:-translate-y-2 ${
    ...
    <div className="relative z-1">
      ...
      <div className="flex justify-center relative z-1 gap-5 mt-6 border-t border-gray-50 pt-6">
        {member.github && (
    ...
    <div className="absolute inset-0 z-0 opacity-[20%] pointer-events-none overflow-hidden">
        <img className="w-100 relative top-10 left-40" src={logo} alt="" />
      </div>
  </div>
);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {executive.map((item, index) => (
            <div key={`exec-${index}`} className="w-full md:w-[300px]">
