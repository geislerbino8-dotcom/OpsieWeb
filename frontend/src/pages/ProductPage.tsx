...
function ProductPage() {
  return (
    <div className="flex flex-col items-center justify-center w-full">
      ...
      {/* Product Header */}
      <div className="w-full h-screen flex flex-col justify-center px-4 md:px-16">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-12">
          ...
          <div className="flex flex-wrap gap-4 md:w-1/2 justify-center">
            {[1,2,3,4].map((_, idx) => (
              <img key={idx} src={Product1} alt={`Product ${idx+1}`} className="w-40 md:w-48 lg:w-52 rounded-lg shadow-md" />
            ))}
          </div>
